...
{
    /// <summary>
    /// ViewModel for the Analytics & Insights page.
    /// Performs deep data analysis on journal entries to visualize patterns in mood, behavior, and time.
    /// </summary>
    public partial class AnalyticsViewModel : BaseViewModel
    {
        private readonly JournalService _journalService;

        // --- Chart Series (Bound to LiveCharts UI) ---
        ...
        /// <summary>
        /// A "Plain English" intelligence summary generated by analyzing all data points.
        /// </summary>
        [ObservableProperty]
        ...
        /// <summary>
        /// Orchestrates the total data analysis process.
        /// Aggregates and transforms raw database entries into chart-ready series.
        /// </summary>
        [RelayCommand]
        public async Task LoadAnalyticsAsync()
        {
            try
            {
                ...
                // 1. ANALYSIS: Mood Distribution (Pie Chart)
                ...
                // 2. ANALYSIS: Word Count Trend (Line Chart)
                ...
                WordTrendSeries.Add(new LineSeries<double>
                {
                    Values = wordCounts,
                    Name = "Words",
                    // Styled with gradients and smooth strokes
                ...
                // 3. ANALYSIS: Time Patterns (Grouping entries by hour)
                ...
                TimePatternSeries.Add(new ColumnSeries<double>
                {
                    ...
                    Rx = 8, Ry = 8, // Rounded corners for premium feel
                    Padding = 10,
                    DataLabelsPaint = new SolidColorPaint(SKColor.Parse("#94A3B8")),
                    DataLabelsPosition = LiveChartsCore.Measure.DataLabelsPosition.Top
                });

                // 4. ANALYSIS: Tag Popularity Top 5 (Bar Chart)
                ...
                // 5. GENERATE STATS: Final Summary Statistics
                ...
                // Smart AI-like Insight Generation
        ...
        /// <summary>
        /// Categorizes a DateTime into a logical human time slot (Morning, Afternoon, etc.)
        /// Used for identifying peak journaling habits.
        /// </summary>
